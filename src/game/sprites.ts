...
export const STAGES: Stage[] = [
  {
    ...
    legend: 'Маршируют зигзагом и бьют очередями ревью-правок',
    boss: 'ДРЕЙФ ЦЕЛИ',
    bossLegend: 'Уводит задачу в сторону очередями. Не дай уйти от цели',
    accent: '#E3C24E',
    tint: '#122430',
  },
  {
    ...
    enemy: 'slop',
    enemyName: 'AI Slop',
    legend: 'Пикируют на тебя и кидают жирные блобы. Убьёшь — разделится',
    boss: 'ПОДХАЛИМАЖ',
    bossLegend: 'Заваливает «отличными» блобами. Не верь — бей',
    accent: '#B98BF0',
    tint: '#171F31',
  },
  {
    ...
    legend: 'Монолиты льют непрерывный поток техдолга вниз',
    boss: 'ТУННЕЛЬНОЕ МЫШЛЕНИЕ',
    bossLegend: 'Прёт напролом и заливает всё сплошным огнём',
    accent: '#3BD269',
    tint: '#0C2822',
  },
  {
    ...
    legend: 'Телепортируются и пускают наводящиеся фантомы',
    boss: 'ОТРАВЛЕНИЕ КОНТЕКСТА',
    bossLegend: 'Его фантомы сами найдут тебя. Сбивай их и бей',
    accent: '#E89B5A',
    tint: '#241E18',
  },
  {
    ...
    legend: 'Кружат по спирали, огонь вращается вокруг них',
    boss: 'АТРОФИЯ ИНСТРУКЦИЙ',
    bossLegend: 'Двойная спираль огня. Двигайся по кругу',
    accent: '#5AB8E8',
    tint: '#0E2430',
  },
  {
    ...
    legend: 'Сбрасывают бомбы с таймером. Сбивай их или беги',
    boss: 'КАСКАДНЫЙ СБОЙ',
    bossLegend: 'Бомбы + веер. Одна ошибка заражает всё. Финал',
    accent: '#E87BA8',
    tint: '#231A24',
  },
]
...
export const ENEMY_DEF: Record<string, { hp: number; r: number; vy: number; score: number; w: number; chunk: string }> = {
  olddev: { hp: 1, r: 0.55, vy: 72, score: 40, w: 11, chunk: C.brown },
  slop: { hp: 1, r: 0.55, vy: 62, score: 50, w: 11, chunk: C.pink },
  legacy: { hp: 3, r: 0.62, vy: 54, score: 90, w: 12, chunk: C.dangerDark },
  hallu: { hp: 1, r: 0.55, vy: 72, score: 70, w: 11, chunk: C.violet },
  loop: { hp: 2, r: 0.55, vy: 56, score: 80, w: 11, chunk: C.cyan },
  rot: { hp: 2, r: 0.58, vy: 50, score: 90, w: 11, chunk: C.brown },
}
